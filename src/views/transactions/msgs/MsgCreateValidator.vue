      ...
      <div class="row p-1">
        ...
        <div class="col-12 col-md-9 text-break com-font-s14-w400">
          <dl>
            ...
            <dt
              class="com-font-s14-w700"
              v-text="$t('labels.securityContact')"
            />
            <dd
              class="com-font-s14-w400"
              v-text="descriptionSecurity"
            />
            <dt
              class="com-font-s14-w700"
...
export default {
  ...
  computed: {
    descriptionMoniker() {
      return this.message.value.description && this.message.value.description.moniker
        ? this.message.value.description.moniker
        : "-";
    },
    descriptionIdentity() {
      return this.message.value.description && this.message.value.description.identity
        ? this.message.value.description.identity
        : "-";
    },
    descriptionWebsite() {
      return this.message.value.description && this.message.value.description.website
        ? this.message.value.description.website
        : "-";
    },
    descriptionSecurity() {
      return this.message.value.description && this.message.value.description.security_contact
        ? this.message.value.description.security_contact
        : "-";
    },
    descriptionDetails() {
      return this.message.value.description && this.message.value.description.details
    ...
    rateChange() {
      return this.message.value.commission && this.message.value.commission.max_change_rate
    ...
    rateMax() {
      return this.message.value.commission && this.message.value.commission.max_rate
    ...
    amount() {
      let amount = this.message.value.value && this.message.value.value.amount ? this.message.value.value.amount : "0";
      let denom = this.message.value.value && this.message.value.value.denom ? this.message.value.value.denom : "-";
