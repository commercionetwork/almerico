...
describe('store/dex/detail/actions', () => {
  beforeEach(() => {
    mockError = false;
    mockResponse = null;
  });
  ...
  test('if "initDexDetail" reset store, set loading state, dispatch wanted actions,; if no account is connected set to false has wallet', async () => {
    ...
    await actions.initDexDetail({ commit, dispatch, rootGetters }, address);
