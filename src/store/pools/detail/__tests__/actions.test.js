...
describe('store/pools/detail/actions', () => {
  beforeEach(() => {
    mockError = false;
    mockResponse = null;
  });
  ...
  test('if "initPoolsDetail" reset store, set loading state, dispatch wanted actions,; if no account is connected set to false has wallet', async () => {
    ...
    await actions.initPoolsDetail({ commit, dispatch, rootGetters }, address);
